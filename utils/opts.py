...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/flair_roi_outputs/precision_0.5805_num_55/epoch_55.pth', help='fine-tune from checkpoint')
