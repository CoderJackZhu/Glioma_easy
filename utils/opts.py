...
parser.add_argument('--train_list', default='/media/spgou/DATA/ZYJ/Glioma_easy/dataset/ucsf_train_patients.txt', type=str, help='the path of training samples text file')
parser.add_argument('--val_list', default='/media/spgou/DATA/ZYJ/Glioma_easy/dataset/ucsf_test_patients.txt', type=str, help='the path of validation samples text file')
...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/ucsf_roi_who_outputs/precision_0.9010_num_275/epoch_275.pth', help='fine-tune from checkpoint')
...
parser.add_argument('--output', type=str, default='./results/ucsf_roi_who_outputs', help='save dir for logs and outputs')
