...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/all_roi_expand_aug_cls2_outputs/precision_0.6609_num_40/epoch_40.pth', help='fine-tune from checkpoint')
...
parser.add_argument('--output', type=str, default='./reesults/all_roi_expand_aug_cls2_outputs', help='save dir for logs and outputs')
