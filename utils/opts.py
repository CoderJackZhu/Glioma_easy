...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/outputs/precision_0.6264_num_95/epoch_95.pth', help='fine-tune from checkpoint')
