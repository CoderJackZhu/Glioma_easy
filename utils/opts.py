...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/all_roi_cls2_outputs/precision_0.7184_num_170/epoch_170.pth', help='fine-tune from checkpoint')
...
parser.add_argument('--output', type=str, default='./all_roi_cls2_outputs', help='save dir for logs and outputs')
