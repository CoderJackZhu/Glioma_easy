...
parser.add_argument('--tune_from', type=str, default='/media/spgou/DATA/ZYJ/Glioma_easy/t2_outputs/precision_0.5690_num_175/epoch_175.pth', help='fine-tune from checkpoint')
