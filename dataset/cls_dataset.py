...
class ClsDataset(Dataset):
    ...
    def _parser_input_data(self, use_h5py: bool = True):
        """
...
if __name__ == '__main__':
    split_train_test(
        glioma_dir='/media/spgou/DATA/ZYJ/Dataset/RadiogenomicsProjects/GliomasSubtypes/PreprocessedImages/XiangyaHospital_train/zscore/zscore_normalizedImages_normal')
